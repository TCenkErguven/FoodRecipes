...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RecipeAndCategoryManagerException.class)
    public ResponseEntity<ErrorMessage> handleManagerException(RecipeAndCategoryManagerException ex) {
